...
const habits = [
  {
    id: 'leer',
    description: 'Leer por lo menos 15 min',
    frequency: [1, 2, 3, 4, 5],
    name: 'Leer',
  },
  {
    id: 'levantarse',
    description: "Levantarse 7 am como m´ximo",
    frequency: [1, 2, 4, 3, 5, 6],
    name: 'Levantarse temprano',
  },
  {
    id: 'correr',
    description: 'Correr por lo menos 20 min',
    frequency: [1, 3, 5],
    name: 'Correr',
  },
  {
    id: 'meditacion',
    description: 'Para calmar la ansiedad',
    frequency: [0, 1, 2, 3, 4, 5, 6],
    name: 'Meditación',
  },
  {
    id: 'intrumento',
    description: 'Practicar acordes mayores en la guitarra',
    frequency: [2, 4, 6],
    name: 'Tocar guitarra',
  },
];
